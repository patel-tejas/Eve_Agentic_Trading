...
description: >-
  Use when discussing or configuring backtests: execution model, costs and
  slippage assumptions, metric definitions, or when interpreting
  run_backtest_signals and compare_timeframes results. Trigger keywords:
  backtest, slippage, costs, profit factor, drawdown, sharpe, next-candle.
---
